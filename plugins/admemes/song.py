...
@Client.on_message(filters.command('yt_search') & ~filters.private & ~filters.channel)
def song(client, message):
    ...
    try:
        ...
        rep = '**𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴 ›› [𝙲𝙷𝙰𝙽𝙽𝙴𝙻](https://t.me/+lTqDjM0PiH9hNThl)**\n**𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 ›› [Stark](https://t.me/Dark_World7_4)**'
